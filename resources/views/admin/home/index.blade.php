                            ...
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-stripped">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ Request::root() }}/admin/img/gallery/2s.jpg">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ Request::root() }}/admin/img/gallery/1s.jpg">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ Request::root() }}/admin/img/gallery/3s.jpg">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ Request::root() }}/admin/img/gallery/4s.jpg">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ Request::root() }}/admin/img/gallery/5s.jpg">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ Request::root() }}/admin/img/gallery/6s.jpg">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ Request::root() }}/admin/img/gallery/7s.jpg">
                                            </td>
                                            <td>
