                        ...
                        <div class="ibox-content" >
                            <div class="form-horizontal" style="direction: rtl; font-size: 25px">
                                <div class="form-group"  style="width:60%">
                                    <div class="col-sm-7">
                                    <input type="text" id="customer" name="customer" class="form-control" value="{{ $bill->customer }}" readonly></div>
                                    <label class="col-sm-5 control-label">اسم العميل:</label>
                                </div>
                                <div class="form-group"  style="width:60%">
                                    <div class="col-sm-7">
                                    <input type="text" id="bill_note" name="bill_note" class="form-control" value="{{ $bill->bill_note }}" readonly></div>
                                    <label class="col-sm-5 control-label">ملاحظات الفاتورة:</label>
                                </div>
                                <div class="form-group" style="width:60%">
                                    <div class="col-sm-7">
                                        <input type="text" id="status" name="status" class="form-control" value="{{ $bill->status }}" readonly>
                            ...
                            <div class="table-responsive" style="min-height: 400px">
                                <table class="table table-striped table-bordered table-hover " style="direction:rtl;">
                                    ...
                                    @foreach ($products as $product)
                                        ...
                                        <tr class="gradeA" id="Row-{{ $i }}">
                                            ...
                                            <td id="cellF-{{ $i }}">
                                                <input style="width: 100%;" type="text" id="notes-{{ $i }}" name="notes-{{ $i }}" class="form-control" placeholder="اكتب الملاحظة" value="{{ $product->note }}" readonly>
                                            </td>
                                        </tr>
                                    @endforeach
                                ...
                                @if (Auth::user()->admin == 1)
                                    <form action="{{ url('/admin/bill/'.$bill->id.'/edit') }}">
                                        <button type="submit" class="btn btn-outline-secondary" style="float: left">تعديل</button>
                                        {{-- <a href="{{ url('/admin/bill/'.$product->id.'/edit') }}">تعديل </a> --}}
                                    </form>
                                @endif
